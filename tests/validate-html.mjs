...
const expectations = [
  ...
  ["hero banner no border CSS", /\.hero-banner\s*{[^}]*border:\s*0\b/],
...
const forbiddenHtml = [
  ...
  ["banner rounded chrome", /\.hero-banner\s*{[^}]*border-radius\s*:/],
  ["banner shadow chrome", /\.hero-banner\s*{[^}]*box-shadow\s*:/],
  ["banner image crop", /\.hero-banner-image\s*{[^}]*object-fit\s*:/],
];
